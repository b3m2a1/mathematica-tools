...
PacletSettingsLookup::usage=
	"Lookup for the PacletTools settings";
...
PacletSettingsLookup[key_]:=
	Lookup[$PacletSettings, key];
PacletSettingsLookup[key_, default_]:=
	Lookup[$PacletSettings, key, default];
PacletSettingsLookup~SetAttributes~HoldRest;
...
If[PacletSettingsLookup["ClearBuildCacheOnLoad"],
	Quiet@DeleteDirectory[$PacletBuildDirectory, DeleteContents->True];
	];


$PacletBuildRoot:=
	PacletSettingsLookup["BuildRoot"];
$PacletBuildExtension:=
	PacletSettingsLookup["BuildExtension"];
$PacletUseKeychain:=
	PacletSettingsLookup["UseKeychain"];


$FormatPaclets:=
	PacletSettingsLookup["FormatPaclets"];
